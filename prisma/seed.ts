...
export const CATALOG: SeedCategory[] = [
  {
    ...
    icon: "outlet",
    services: [
      { slug: "replace-standard-outlet", name: "Replace Standard Outlet", bookingType: "INSTANT", estimatedMinutes: 20, basePrice: 225, whileWeThereBasePrice: 85, icon: "outlet", description: "Swapping out an existing outlet that's already there — cracked, discolored, loose, or just old — for a brand-new one in the same spot. This does NOT add a new outlet anywhere new; see \"New 120V Outlet\" for that." },
      { slug: "replace-gfci-outlet", name: "Replace GFCI Outlet", bookingType: "INSTANT", estimatedMinutes: 25, basePrice: 295, whileWeThereBasePrice: 170, icon: "outlet", description: "Swapping an existing GFCI (the outlet with the TEST/RESET buttons, usually in kitchens, bathrooms, or garages) for a new one in the same location." },
      { slug: "replace-standard-switch", name: "Replace Standard Switch", bookingType: "INSTANT", estimatedMinutes: 20, basePrice: 225, whileWeThereBasePrice: 75, icon: "switch", description: "Swapping an existing single light switch for a new one in the same location." },
      { slug: "replace-3-way-switch", name: "Replace 3-Way Switch", bookingType: "INSTANT", estimatedMinutes: 25, basePrice: 240, whileWeThereBasePrice: 115, icon: "switch", description: "Swapping one switch in a pair that controls the same light from two locations (like a hallway or stairwell)." },
      { slug: "replace-led-dimmer", name: "Replace LED Dimmer", bookingType: "INSTANT", estimatedMinutes: 25, basePrice: 305, whileWeThereBasePrice: 180, icon: "switch", description: "Swapping an existing dimmer switch for a new LED-compatible dimmer in the same location." },
      { slug: "customer-supplied-smart-switch", name: "Customer-Supplied Smart Switch", bookingType: "ADJUSTED", estimatedMinutes: 30, basePrice: 250, whileWeThereBasePrice: 125, icon: "switch", description: "Installing a smart switch you've already purchased (Lutron, Kasa, etc.) in place of an existing switch. We'll confirm your wiring has a neutral wire before booking." },
      { slug: "usb-outlet-upgrade", name: "USB / USB-C Outlet Upgrade", bookingType: "INSTANT", estimatedMinutes: 25, basePrice: 320, whileWeThereBasePrice: 195, icon: "outlet", description: "Replacing an existing outlet with a combo outlet that includes built-in USB / USB-C charging ports." },
      { slug: "smart-outlet-upgrade", name: "Smart Outlet Upgrade", bookingType: "ADJUSTED", estimatedMinutes: 30, basePrice: 405, whileWeThereBasePrice: 280, icon: "outlet", description: "Replacing an existing outlet with a Wi-Fi smart outlet you can control from your phone." },
      { slug: "occupancy-motion-switch", name: "Occupancy / Motion Sensor Switch", bookingType: "INSTANT", estimatedMinutes: 30, basePrice: 355, whileWeThereBasePrice: 230, icon: "switch", description: "Replacing an existing switch with one that turns the light on/off automatically based on motion in the room." },
      { slug: "timer-switch-install", name: "Timer Switch Installation", bookingType: "INSTANT", estimatedMinutes: 30, basePrice: 405, whileWeThereBasePrice: 280, icon: "switch", description: "Replacing an existing switch with a timer switch that turns the light off automatically after a set time." },
    ],
  },
  {
    slug: "new-outlets",
    ...
    services: [
      { slug: "new-120v-outlet", name: "New 120V Outlet", bookingType: "ADJUSTED", estimatedMinutes: 60, basePrice: 445, whileWeThereBasePrice: 320, icon: "new-outlet", description: "Adding a brand-new outlet somewhere that doesn't currently have one — a new location on your wall, not a replacement of an existing outlet. Price depends on whether we have attic/basement access or need to open the wall." },
      ...
      { slug: "exterior-gfci-standard", name: "Exterior GFCI — Back-to-Back Power", bookingType: "INSTANT", estimatedMinutes: 60, basePrice: 500, whileWeThereBasePrice: 375, icon: "exterior-outlet", description: "A new outdoor weatherproof GFCI outlet, in a location with power already available directly on the other side of that exterior wall." },
      ...
      { slug: "garage-door-opener-outlet", name: "Garage Door Opener Outlet", bookingType: "ADJUSTED", estimatedMinutes: 60, basePrice: 445, whileWeThereBasePrice: 320, icon: "new-outlet", description: "A new outlet installed near your garage door opener motor on the ceiling, so it's no longer running on an extension cord." },
      { slug: "bidet-smart-toilet-outlet", name: "Bidet / Smart Toilet Outlet", bookingType: "ADJUSTED", estimatedMinutes: 60, basePrice: 445, whileWeThereBasePrice: 320, icon: "new-outlet", description: "A new outlet installed near the toilet to power a bidet attachment or smart toilet seat." },
    ],
  },
  {
    slug: "lighting",
    ...
    icon: "light",
    services: [
      { slug: "replace-interior-light-fixture", name: "Replace Interior Light Fixture", bookingType: "INSTANT", estimatedMinutes: 30, basePrice: 250, whileWeThereBasePrice: 150, icon: "light", description: "Removing your existing interior light fixture and installing a new one you provide, in the same location." },
      { slug: "replace-exterior-light-fixture", name: "Replace Exterior Light Fixture", bookingType: "INSTANT", estimatedMinutes: 35, basePrice: 275, whileWeThereBasePrice: 165, icon: "light", description: "Removing your existing outdoor light fixture and installing a new one you provide, in the same location." },
      { slug: "replace-motion-flood-light", name: "Replace Motion / Flood Light", bookingType: "INSTANT", estimatedMinutes: 35, basePrice: 290, whileWeThereBasePrice: 165, icon: "light", description: "Swapping an existing motion-activated or flood light fixture for a new one in the same location." },
      { slug: "recessed-lighting", name: "Recessed Lighting Installation", bookingType: "ADJUSTED", estimatedMinutes: 45, basePrice: 375, whileWeThereBasePrice: 190, icon: "recessed", description: "Adding a new recessed \"can\" light into an existing ceiling. Add more lights in the same visit for a lower per-light rate. Final price depends on attic access and whether there's an existing fixture or switch to work from." },
  ...
  },
  {
    ...
    icon: "fan",
    services: [
      { slug: "replace-ceiling-fan", name: "Replace Existing Ceiling Fan", bookingType: "INSTANT", estimatedMinutes: 45, basePrice: 375, whileWeThereBasePrice: 250, icon: "fan", description: "Removing your existing ceiling fan and installing a new one you provide, in the same location, using the existing electrical box." },
      { slug: "new-ceiling-fan", name: "Install New Ceiling Fan", bookingType: "ADJUSTED", estimatedMinutes: 75, basePrice: 440, whileWeThereBasePrice: 315, icon: "fan", description: "Adding a ceiling fan in a location that doesn't currently have one — needs a fan-rated electrical box, different from replacing an existing fan. Final price depends on attic access and whether there's an existing fixture or switch to work from." },
      { slug: "fan-replacing-light", name: "Fan Replacing Existing Light", bookingType: "ADJUSTED", estimatedMinutes: 60, basePrice: 440, whileWeThereBasePrice: 315, icon: "fan", description: "Removing a ceiling light fixture (not a fan) and installing a ceiling fan in its place — this requires confirming the existing box can support a fan's weight." },
      ...
      { slug: "bathroom-fan-light-combo", name: "Bathroom Exhaust Fan + Light Combo", bookingType: "ADJUSTED", estimatedMinutes: 75, basePrice: 565, whileWeThereBasePrice: 440, icon: "exhaust-fan", description: "Replacing a bathroom exhaust fan with a combination fan/light unit in the same location." },
    ],
  },
  {
    slug: "tv-media",
    ...
    icon: "tv",
    services: [
      { slug: "tv-installation", name: "Professional TV Installation", bookingType: "ADJUSTED", estimatedMinutes: 60, basePrice: 500, whileWeThereBasePrice: 375, requiresTechCount: 1, icon: "tv", description: "Mounting your TV on the wall, with cable concealment. Price adjusts based on TV size and what's needed for power. Does not include the mount itself unless you add one." },
      { slug: "tv-install-existing-location", name: "Install TV in Existing Location", bookingType: "ADJUSTED", estimatedMinutes: 30, basePrice: 315, whileWeThereBasePrice: 225, icon: "tv", description: "Mounting your TV where power and cable routing are already in place — no new outlet or cable concealment needed, so it's faster and less expensive than a full installation." },
      { slug: "soundbar-installation", name: "Soundbar Installation", bookingType: "REMOTE_QUOTE", icon: "tv", description: "Mounting a soundbar below an already-mounted TV. Visible-cable installations can be priced directly; in-wall concealment requires review." },
      { slug: "tilt-tv-mount", name: "Tilt TV Mount", bookingType: "ADJUSTED", estimatedMinutes: 15, basePrice: 125, whileWeThereBasePrice: 125, icon: "mount", active: false, description: "A tilting wall mount supplied by your electrician, added to a TV installation if you don't already have a compatible mount." },
      { slug: "articulating-tv-mount", name: "Full-Motion Articulating Mount", bookingType: "ADJUSTED", estimatedMinutes: 20, basePrice: 200, whileWeThereBasePrice: 200, icon: "mount", active: false, description: "A full-motion (swivel/extend) wall mount supplied by your electrician, added to a TV installation if you don't already have a compatible mount." },
    ],
  },
  {
    ...
    icon: "appliance",
    services: [
      { slug: "otr-microwave-install", name: "Remove and Replace Existing Microwave", bookingType: "INSTANT", estimatedMinutes: 45, basePrice: 375, whileWeThereBasePrice: 250, icon: "kitchen-appliance", description: "Removing your existing over-the-range microwave and installing a new one in the same spot, using the electrical connection that's already there." },
      { slug: "install-new-microwave", name: "Install New Microwave", bookingType: "ADJUSTED", estimatedMinutes: 60, basePrice: 500, whileWeThereBasePrice: 375, icon: "kitchen-appliance", description: "Installing an over-the-range microwave in a spot that doesn't already have one — for example, above a cooktop with no hood or existing microwave. Price depends on what's currently there." },
      { slug: "dishwasher-electrical", name: "Dishwasher Electrical Connection / Replacement", bookingType: "INSTANT", estimatedMinutes: 30, basePrice: 275, whileWeThereBasePrice: 190, icon: "kitchen-appliance", description: "The electrical connection for a new or replacement dishwasher, using wiring that's already there." },
      { slug: "garbage-disposal-install", name: "Disconnect / Reconnect Garbage Disposal", bookingType: "INSTANT", estimatedMinutes: 20, basePrice: 250, whileWeThereBasePrice: 175, icon: "kitchen-appliance", description: "Disconnecting and reconnecting your existing garbage disposal — for example, while a sink or countertop is being replaced. We do not install a new disposal unit." },
      { slug: "range-receptacle-replacement", name: "Replace 220V Electric Range/Stove Outlet", bookingType: "INSTANT", estimatedMinutes: 45, basePrice: 315, whileWeThereBasePrice: 215, icon: "kitchen-appliance", disclaimer: "We do not move built-in ovens or stoves — this replaces the outlet in its current location only.", description: "Replacing the existing high-voltage outlet behind your electric range/stove, in the same location." },
      { slug: "dryer-receptacle-replacement", name: "Remove and Replace Existing 220V Dryer Outlet", bookingType: "INSTANT", estimatedMinutes: 45, basePrice: 315, whileWeThereBasePrice: 215, icon: "laundry", disclaimer: "If this is a stackable washer/dryer unit, we do not move it — the outlet will be serviced in its current location.", description: "Replacing the existing high-voltage outlet behind your dryer, in the same location." },
    ],
  },
  {
    ...
    icon: "shield",
    services: [
      { slug: "hardwired-smoke-detector", name: "Hardwired Smoke Detector", bookingType: "INSTANT", estimatedMinutes: 20, basePrice: 265, whileWeThereBasePrice: 150, icon: "smoke-detector", description: "Replacing an existing hardwired smoke detector in the same location." },
      { slug: "smoke-co-detector", name: "Smoke / CO Detector", bookingType: "INSTANT", estimatedMinutes: 25, basePrice: 365, whileWeThereBasePrice: 240, icon: "smoke-detector", description: "Replacing an existing hardwired combination smoke/carbon monoxide detector in the same location." },
      { slug: "whole-house-surge-protection", name: "Whole-House Surge Protection", bookingType: "ADJUSTED", estimatedMinutes: 45, basePrice: 685, whileWeThereBasePrice: 560, icon: "surge", description: "Installing a surge protector directly at your electrical panel to protect everything in your home from power surges." },
      { slug: "home-electrical-safety-inspection", name: "Home Electrical Safety Inspection", bookingType: "INSTANT", estimatedMinutes: 60, basePrice: 375, whileWeThereBasePrice: 315, icon: "inspection", description: "A general visual and functional inspection of your home's electrical system, with a written summary of anything that needs attention." },
    ],
  },
  {
    ...
    icon: "smart-home",
    services: [
      { slug: "video-doorbell-existing-wiring", name: "Video Doorbell — Existing Wiring", bookingType: "INSTANT", estimatedMinutes: 30, basePrice: 250, whileWeThereBasePrice: 150, icon: "doorbell", description: "Installing a video doorbell (Ring, Nest, etc.) you provide, using your existing doorbell wiring." },
      ...
      { slug: "floodlight-camera-existing", name: "Floodlight Camera at Existing Fixture", bookingType: "INSTANT", estimatedMinutes: 35, basePrice: 290, whileWeThereBasePrice: 175, icon: "camera", description: "Installing a floodlight security camera in place of an existing exterior light fixture." },
      ...
      { slug: "smart-thermostat-install", name: "Smart Thermostat Installation", bookingType: "INSTANT", estimatedMinutes: 30, basePrice: 250, whileWeThereBasePrice: 150, icon: "thermostat", description: "Installing a smart thermostat you provide, in place of your existing thermostat." },
      { slug: "doorbell-transformer-replacement", name: "Doorbell Transformer Replacement", bookingType: "INSTANT", estimatedMinutes: 30, basePrice: 320, whileWeThereBasePrice: 220, icon: "doorbell", description: "Replacing the low-voltage transformer that powers your doorbell system." },
    ],
  },
  {
    ...
    icon: "panel",
    services: [
      { slug: "single-pole-breaker-replacement", name: "Single-Pole Breaker Replacement", bookingType: "INSTANT", estimatedMinutes: 20, basePrice: 280, whileWeThereBasePrice: 145, icon: "breaker", description: "Replacing a single standard breaker in your electrical panel." },
      { slug: "double-pole-breaker-replacement", name: "Double-Pole Breaker Replacement", bookingType: "INSTANT", estimatedMinutes: 25, basePrice: 365, whileWeThereBasePrice: 215, icon: "breaker", description: "Replacing a double-pole (240V) breaker in your electrical panel." },
      { slug: "electrical-troubleshooting", name: "Electrical Troubleshooting", bookingType: "TROUBLESHOOT_ONLY", estimatedMinutes: 60, basePrice: 250, icon: "troubleshooting", description: "For when something's wrong but you're not sure what — a dead outlet, flickering lights, a tripping breaker. Covers the visit and the first 60 minutes of diagnostic time; the repair itself is quoted separately once we know what's wrong." },
  ...
  },
  {
    ...
    services: [
      ...
      { slug: "new-240v-appliance-circuit", name: "New Dryer or Range Circuit & Outlet", bookingType: "REMOTE_QUOTE", estimatedMinutes: 120, icon: "circuit", description: "A new four-wire circuit and surface-mounted outlet for a standard plug-in electric dryer or range, calculated after contractor review." },
    ],
  },
  {
