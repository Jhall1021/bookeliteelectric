...
const CATALOG: SeedCategory[] = [
  ...
  },
  {
    ...
    services: [
      ...
      { slug: "new-ceiling-fan", name: "Install New Ceiling Fan", bookingType: "ADJUSTED", estimatedMinutes: 75, basePrice: 425, whileWeThereBasePrice: 200, icon: "fan", description: "Adding a ceiling fan in a location that doesn't currently have one — needs a fan-rated electrical box, different from replacing an existing fan. Final price depends on attic access and whether there's an existing fixture or switch to work from." },
