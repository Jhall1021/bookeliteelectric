...
export const ELECTRICAL_LABOR_SCOPE_COLLECTION_GROUPS: Record<string, CollectionGroupCopy> = {
  ...
  SPA_CONFIGURATION_REVIEW: { title: "Spa electrical configuration review", instruction: "Have the contractor confirm the equipment instructions, exact 50A four-wire configuration, panel capacity, disconnect location, wet-location wiring method and absence of remediation or specialty routing." },
  FIREPLACE_EQUIPMENT_REVIEW: { title: "Fireplace equipment review", instruction: "Have the contractor read the fireplace label or manufacturer instructions and confirm a standard plug-in 120V 15A or 20A package; homeowner guesses are not authority." },
  SUMP_PUMP_PROTECTION_REVIEW: { title: "Sump-pump protection review", instruction: "Have the contractor confirm the selected 20A GFCI protection and receptacle arrangement for the actual location; never ask the homeowner to diagnose code compliance." },
