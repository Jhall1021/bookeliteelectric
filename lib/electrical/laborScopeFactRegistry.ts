...
export const ELECTRICAL_LABOR_SCOPE_FACTS: LaborScopeFactDefinition[] = [
  ...
  fact("routeFeet", "GENERAL_ROUTE_MEASUREMENT", "FEET", ["ROUTE_ASSIST_CONFIRMED", "CONTRACTOR_MEASUREMENT"], "Confirmed end-to-end wiring route length."),
  ...
  fact("newTransformerRequired", "DOORBELL_REMEDIATION_REVIEW", "BOOLEAN", ["GUIDED_PHOTO_REVIEW"], "Whether doorbell transformer remediation is required."),
