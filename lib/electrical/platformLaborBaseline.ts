...
const PLANNING_SEEDS: Record<string, PlanningSeed> = {
  ...
  ELEC_SERVICE_ENTRANCE_CONDUCTOR: { hoursPerUnit: 0.125, sourceKeys: ["INSTALL_SERVICE_CONDUCTORS"], note: "The workbook's 2.50-hour standard service-conductor set normalized across the bounded 20-foot package." },
