        ...
        ? hasBoundedStandard
          ...
          : POLICY_CONNECTED_ATOMIC_SERVICE_SLUGS.has(serviceSlug)
            ...
            : REVIEWED_ELECTRIC_FIREPLACE_SLUGS.has(serviceSlug)
              ? "The standard plug-in 120V package prices from the homeowner's observable 15A/20A equipment requirement and conservative accessible-route band. Exact breaker and cable costs, approved atomic labor and contractor pricing rules produce the price; photos confirm the assumptions, while hardwired, 240V, specialty-wall, inaccessible and remediation scopes remain review-only."
            ...
            : REVIEWED_APPLIANCE_240V_SLUGS.has(serviceSlug)
              ? "The modern four-wire plug-in appliance package prices a 30A dryer or 50A range from the observable connection, surface-box choice and conservative accessible-route band. Exact breaker, cable and receptacle materials, approved atomic labor and pricing rules produce the price; legacy three-wire, hardwired, flush-wall, finished-route and remediation scopes remain review-only."
