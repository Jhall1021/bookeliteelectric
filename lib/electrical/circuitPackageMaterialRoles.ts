...
export const CIRCUIT_PACKAGE_MATERIAL_ROLE_KEYS_BY_SERVICE = {
  ...
  "240v-garage-outlet": ["BREAKER_DOUBLE_POLE_30A", "RECEPTACLE_6_30", "WIRE_10_2", "BOX_SURFACE_4S", "COVER_RAISED_4S", "CONSUMABLES_MEDIUM", "NM_CABLE_SUPPORT"],
  "240v-garage-outlet-14-30": ["BREAKER_DOUBLE_POLE_30A", "RECEPTACLE_14_30", "WIRE_10_3", "BOX_SURFACE_4S", "COVER_RAISED_4S", "CONSUMABLES_MEDIUM", "NM_CABLE_SUPPORT"],
  "240v-garage-outlet-6-50": ["BREAKER_DOUBLE_POLE_50A", "RECEPTACLE_6_50", "WIRE_6_2", "BOX_SURFACE_4S", "COVER_RAISED_4S", "CONSUMABLES_MEDIUM", "NM_CABLE_SUPPORT"],
  "240v-garage-outlet-14-50": ["BREAKER_DOUBLE_POLE_50A", "RECEPTACLE_14_50", "WIRE_6_3", "BOX_SURFACE_4S", "COVER_RAISED_4S", "CONSUMABLES_MEDIUM", "NM_CABLE_SUPPORT"],
  "new-ethernet-line": ["CABLE_CAT6", "JACK_KEYSTONE_RJ45", "LOW_VOLTAGE_RING", "WALL_PLATE", "CONSUMABLES_SMALL"],
  "new-coax-line": ["CABLE_RG6", "JACK_COAX_F", "LOW_VOLTAGE_RING", "WALL_PLATE", "CONSUMABLES_SMALL"],
} as const;
