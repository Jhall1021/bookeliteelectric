...
export const ELECTRICAL_ATOMIC_LABOR_RECIPES: LaborRecipe[] = [
  ...
  { key: "ELECTRICAL_HOT_TUB_SPA", trade: "electrical", appliesTo: ["hot-tub-spa-electrical"], lines: [c("ELEC_ROUTE_LAYOUT_SETUP", 1), c("ELEC_REPLACE_DOUBLE_POLE_BREAKER", 1), m("ELEC_EXTERIOR_CONDUIT", "racewayFeet"), m("ELEC_PULL_POWER_CONDUCTORS", "conductorFeet"), c("ELEC_INSTALL_SPA_DISCONNECT", 1), c("ELEC_TERMINATE_OUTDOOR_EQUIPMENT", 1), { operationKey: "ELEC_INSTALL_EQUIPOTENTIAL_BOND", quantity: { kind: "contractor-input", fact: "bondingConnectionCount", unit: "each" } }] },
...
export const ELECTRICAL_LABOR_CALIBRATION_GROUPS: LaborCalibrationGroup[] = [
  ...
  },
  {
    ...
    relatedOperationKeys: ["ELEC_INSTALL_PANEL_INTERLOCK", "ELEC_INSTALL_TRANSFER_SWITCH", "ELEC_TRANSFER_BRANCH_CIRCUIT", "ELEC_EXTERIOR_CONDUIT", "ELEC_PULL_POWER_CONDUCTORS", "ELEC_TERMINATE_OUTDOOR_EQUIPMENT", "ELEC_INSTALL_EQUIPOTENTIAL_BOND", "ELEC_LANDSCAPE_CABLE", "ELEC_INSTALL_LANDSCAPE_FIXTURE", "ELEC_INSTALL_NEW_EXTERIOR_LIGHT_POINT"], method: "RELATIONSHIP_PROPOSAL",
