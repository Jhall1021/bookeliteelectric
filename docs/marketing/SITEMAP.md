...
| Menu | Contains | Notes |
|---|---|---|
| **Product ▾** | Overview · Guided Pricing · While We're There™ · Online Booking · Website Embed & Pricing Links | |
...
Five pages: Overview, Guided Pricing, While We're There™, Online Booking,
Website Embed & Pricing Links.

**Own:** the mechanism, once each. Guided Pricing owns the decision tree and
routing. While We're There™ owns the two-price model. Online Booking owns
availability, duration and capacity. Embed owns where the pricing page lives and
how a link travels.
...
conversational onboarding · keep your existing workflow.

**Owns:** the adoption objection. This is where *"you don't have to flat-rate
your whole business"* graduates from a homepage section into the page that
answers it fully — including the three-trade columns of everyday calls.
