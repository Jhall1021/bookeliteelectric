...
check(service?.kind === "STANDARD" && service.facts.serviceEntranceFeet === 20 && service.facts.groundingElectrodeCount === 2, "service upgrade uses its defined feeder and electrode quantities");
