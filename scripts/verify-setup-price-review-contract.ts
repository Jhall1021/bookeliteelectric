...
ok(panel.includes("Includes replacing the switch plus basic app programming") && panel.includes("Advanced schedules, scenes, automations"), "smart-switch price review states the included basic programming boundary");
