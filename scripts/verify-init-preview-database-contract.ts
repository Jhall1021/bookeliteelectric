...
async function populatedRebuildAndRetryScenario(dbName: string) {
  ...
  try {
    ...
    ok("17. control build produces the expected 76 contractor-visible services and a normalized fingerprint", typeof control.fingerprint === "string" && control.fingerprint.length > 0);
