...
ok(panel.includes("runtimeConnectedCount") && panel.includes("exactButUnwiredCount") && panel.includes("compositeUnwiredCount"), "completion shows the executable route-bridge status rather than a generic disclaimer");
