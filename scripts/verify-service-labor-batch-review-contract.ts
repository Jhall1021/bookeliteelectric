...
ok(route.includes('SELECT id, slug, "isPrimaryEligible"') && route.includes("wwtLaborHours: projection.suggestedHours"), "add-on-only duration approval targets While We're There labor");
