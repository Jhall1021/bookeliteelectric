...
ok(ELECTRICAL_LABOR_SCOPE_FACTS.length === 51 && Object.keys(ELECTRICAL_LABOR_SCOPE_COLLECTION_GROUPS).length === 30, "the 51 labor facts collapse into 30 reusable collection groups");
