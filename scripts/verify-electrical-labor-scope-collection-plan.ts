...
ok(branchPlan.find((task) => task.collectionGroupKey === "ACCESSIBLE_ROUTE_MEASUREMENT")?.collectionPath === "CONTRACTOR_MEASUREMENT", "accessible hidden paths go to contractor measurement");
