...
const evidence: RouteAssistScanEvidenceV1 = {
  ...
  segments: [
    {
      segmentId: "segment-a",
      measuredLengthFt: { value: 8.25, confidence: 0.96, visibility: "CLEAR", basis: "WORLD_GEOMETRY" },
      surface: { value: "WALL", confidence: 0.98, visibility: "CLEAR", basis: "WORLD_GEOMETRY" },
    },
    {
      segmentId: "segment-b",
      measuredLengthFt: { value: 6.75, confidence: 0.97, visibility: "CLEAR", basis: "WORLD_GEOMETRY" },
      surface: { value: "WALL", confidence: 0.98, visibility: "CLEAR", basis: "WORLD_GEOMETRY" },
    },
  ],
  transitions: [
    {
      pointId: "door-turn",
      physicalTurn: { value: "INSIDE", confidence: 0.95, visibility: "CLEAR", basis: "WORLD_GEOMETRY" },
      obstacleContext: { value: "DOORWAY", confidence: 0.93, visibility: "CLEAR", basis: "VISIBLE_SCENE" },
    },
  ],
};
...
const measured = accept(basePoints, baseSegments, {
  measuredLengthSegmentIds: ["segment-a", "segment-b"],
});
const physical = accept(measured.points, measured.segments, {
  surfaceSegmentIds: ["segment-a", "segment-b"],
  physicalTurnPointIds: ["door-turn"],
});
const obstacle = accept(physical.points, physical.segments, {
  routeObstaclePointIds: ["door-turn"],
});
...
check("handoff creates no material, labor or pricing output", () => {
  ...
  for (const forbidden of ["pricecents", "laborhours", "materialtakeoff", "unitcost", "markup"]) {
