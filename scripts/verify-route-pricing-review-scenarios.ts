...
assert.deepEqual(ROUTE_PRICING_REVIEW_SERVICE_SLUGS, [
  "new-120v-outlet", "surface-mounted-fixture-box", "surface-mounted-outlet", "surface-mounted-switch",
]);
...
console.log("route pricing review: 4 reviewed scenarios, tenant guard, explicit selection and stale-price binding passed");
