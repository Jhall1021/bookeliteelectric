...
const layout = computeRecessedLightingMaterialTakeoff({ lightCount: 4, installedCablePathFeet: 32, totalCableSlackFeet: 8, selections });
...
const longLayout = computeRecessedLightingMaterialTakeoff({ lightCount: 4, installedCablePathFeet: 55, totalCableSlackFeet: 8, selections });
...
const missingPath = computeRecessedLightingMaterialTakeoff({ lightCount: 4, installedCablePathFeet: null, totalCableSlackFeet: 8, selections });
...
const missingSlack = computeRecessedLightingMaterialTakeoff({ lightCount: 4, installedCablePathFeet: 32, totalCableSlackFeet: null, selections });
