...
ok(rows.length === 25, "all 25 currently required authority-specific grouped collection tasks have an implementation row");
...
ok(panelCapacity.state === "PARTIAL_RUNTIME_CONNECTION" && panelCapacity.runtimeConnectedServiceSlugs.join() === "240v-garage-outlet,240v-garage-outlet-14-30,240v-garage-outlet-14-50,240v-garage-outlet-6-50,bidet-smart-toilet-outlet,dedicated-120v-circuit-outlet,electric-fireplace-circuit,freezer-fridge-dedicated-circuit,new-240v-appliance-circuit,sump-pump-dedicated-circuit", "panel capacity connects the reviewed 15A entries, plug-in fireplace, sump-specific 20A, dryer/range, and open-garage 240V packages while other circuit scope remains review-bound");
