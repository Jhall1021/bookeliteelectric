...
const BASELINES: Baseline[] = [
  ...
  { key: "CONVERT_SWITCHED_OUTLET_TO_LIGHTING_ACCESSIBLE", hours: 0.75, fallbackMaterialCents: 2500, minutes: 45, source: "seed-lighting-control.ts" },
  { key: "CONVERT_SWITCHED_OUTLET_TO_LIGHTING_FINISHED", hours: 1.25, fallbackMaterialCents: 3500, minutes: 75, source: "seed-lighting-control.ts" },
